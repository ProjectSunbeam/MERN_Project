...
export default function ProfileDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        <div className="rounded-circle bg-primary text-white d-flex align-items-center justify-content-center fw-bold" style={{width: '2.5rem', height: '2.5rem'}}>
          {avatarText}
        </div>
      </button>
        ...
        <div className="dropdown-menu show position-absolute end-0 mt-2" style={{width: '20rem', zIndex: 1050}}>
          ...
          <div className="p-3 border-bottom">
            <div className="d-flex align-items-center gap-3">
              <div className="rounded-circle bg-primary bg-gradient text-white d-flex align-items-center justify-content-center fw-bold" style={{width: '3rem', height: '3rem'}}>
                {avatarText}
              </div>
              <div>
                <h3 className="font-bold text-lg">{profile?.user?.name || 'User'}</h3>
          ...
          <div className="border-top p-3">
            <button onClick={handleLogout} className="btn btn-outline-danger w-100 d-flex align-items-center p-3">
